...
const Display = (() => {
  ...
  const render = () => {
    ...
    _todoManager__WEBPACK_IMPORTED_MODULE_0__["TodoManager"].todos.forEach((todo) => {
...
const EventHandler = (() => {
  ...
  todoMainInput.addEventListener("keypress", (e) => {
    if (e.key === "Enter") {
      _todoManager__WEBPACK_IMPORTED_MODULE_0__["TodoManager"].add(todoMainInput.value);
    }
  });
  ...
  list.addEventListener("keypress", (e) => {
    if (e.key === "Enter" && e.target.classList.contains("todo-input")) {
      ...
      _todoManager__WEBPACK_IMPORTED_MODULE_0__["TodoManager"].edit(todoInputText, todoInputIdNum);
    }
  });
  ...
  list.addEventListener("click", (e) => {
    if (e.target.classList.contains("btn-delete")) {
      ...
      _todoManager__WEBPACK_IMPORTED_MODULE_0__["TodoManager"].deleteTodo(todoDelBtnIdNum);
    }

    if (e.target.classList.contains("checkbox")) {
      const todocheckBoxIdNum = parseInt(e.target.id.match(/[0-9]+/g).join(""));
      _todoManager__WEBPACK_IMPORTED_MODULE_0__["TodoManager"].markCompleted(todocheckBoxIdNum);
    }
  });
})();
